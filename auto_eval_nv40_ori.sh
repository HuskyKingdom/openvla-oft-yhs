...
# swap
sed -i 's/use_environment: true/use_environment: false/' /home/yuhang/Warehouse/Yuhangworkspace/openvla-oft-yhsexperiments/robot/libero/LIBERO-PRO/evaluation_config.yaml
sed -i 's/use_swap: false/use_swap: true/' /home/yuhang/Warehouse/Yuhangworkspace/openvla-oft-yhsexperiments/robot/libero/LIBERO-PRO/evaluation_config.yaml
...
# object
sed -i 's/use_swap: true/use_swap: false/' /home/yuhang/Warehouse/Yuhangworkspace/openvla-oft-yhsexperiments/robot/libero/LIBERO-PRO/evaluation_config.yaml
sed -i 's/use_object: false/use_object: true/' /home/yuhang/Warehouse/Yuhangworkspace/openvla-oft-yhsexperiments/robot/libero/LIBERO-PRO/evaluation_config.yaml
...
# lan
sed -i 's/use_object: true/use_object: false/' /home/yuhang/Warehouse/Yuhangworkspace/openvla-oft-yhsexperiments/robot/libero/LIBERO-PRO/evaluation_config.yaml
sed -i 's/use_language: false/use_language: true/' /home/yuhang/Warehouse/Yuhangworkspace/openvla-oft-yhsexperiments/robot/libero/LIBERO-PRO/evaluation_config.yaml
...
# task
sed -i 's/use_language: true/use_language: false/' /home/yuhang/Warehouse/Yuhangworkspace/openvla-oft-yhsexperiments/robot/libero/LIBERO-PRO/evaluation_config.yaml
sed -i 's/use_task: false/use_task: true/' /home/yuhang/Warehouse/Yuhangworkspace/openvla-oft-yhsexperiments/robot/libero/LIBERO-PRO/evaluation_config.yaml
...
sed -i 's/use_task: true/use_task: false/' /home/yuhang/Warehouse/Yuhangworkspace/openvla-oft-yhsexperiments/robot/libero/LIBERO-PRO/evaluation_config.yaml
