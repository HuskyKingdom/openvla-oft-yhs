...
def finetune(cfg: FinetuneConfig) -> None:
    ...
    energy_sd = torch.load(
        os.path.join("/work1/aiginternal/yuhang/openvla-oft-yhs/ckpoints/openvla-7b-oft-finetuned-libero-spatial-object-goal-10+libero_4_task_suites_no_noops+b24+lr-0.0005+lora-r32+dropout-0.0--image_aug--energy_freeze_refine_action_head--80000_chkpt", f"energy_model--8000_checkpoint.pt"),
