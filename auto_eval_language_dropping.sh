...
python experiments/robot/libero/run_libero_pro_eval_substep.py \
  ...
  --task_label scalled_spatial_swap_withlang --use_eos_detection True --null_instruction False \
  2>&1 | tee ckpts/scalled_spatial_swap_withlang.txt
...
python experiments/robot/libero/run_libero_pro_eval_substep.py \
  ...
  --task_label scalled_10_swap_withlang --use_eos_detection True --null_instruction False \
  2>&1 | tee ckpts/scalled_10_swap_withlang.txt
...
python experiments/robot/libero/run_libero_pro_eval_substep.py \
  ...
  --task_suite_name libero_spatial --e_decoding False --save_video False --use_substep_decomposition True \
  --num_trials_per_task 50 --evaluation_config_path $FILE_PATH --unnorm_key libero_spatial \
  --task_label scalled_spatial_object_withlang --use_eos_detection True --null_instruction False \
  2>&1 | tee ckpts/scalled_spatial_object_withlang.txt

python experiments/robot/libero/run_libero_pro_eval_substep.py \
  --pretrained_checkpoint $CKPT_APD --substep_completion_threshold 0.07 \
  --task_suite_name libero_10 --e_decoding False --save_video False --use_substep_decomposition True \
  --num_trials_per_task 50 --evaluation_config_path $FILE_PATH --unnorm_key libero_10 \
  --task_label scalled_10_object_withlang --use_eos_detection True --null_instruction False \
  2>&1 | tee ckpts/scalled_10_object_withlang.txt
...
python experiments/robot/libero/run_libero_pro_eval_substep.py \
  ...
  --task_suite_name libero_spatial --e_decoding False --save_video False --use_substep_decomposition True \
  --num_trials_per_task 50 --evaluation_config_path $FILE_PATH --unnorm_key libero_spatial \
  --task_label scalled_spatial_lan_withlang --use_eos_detection True --null_instruction False \
  2>&1 | tee ckpts/scalled_spatial_lan_withlang.txt

python experiments/robot/libero/run_libero_pro_eval_substep.py \
  --pretrained_checkpoint $CKPT_APD --substep_completion_threshold 0.07 \
  --task_suite_name libero_10 --e_decoding False --save_video False --use_substep_decomposition True \
  --num_trials_per_task 50 --evaluation_config_path $FILE_PATH --unnorm_key libero_10 \
  --task_label scalled_10_lan_withlang --use_eos_detection True --null_instruction False \
  2>&1 | tee ckpts/scalled_10_lan_withlang.txt
...
python experiments/robot/libero/run_libero_pro_eval_substep.py \
  ...
  --task_suite_name libero_spatial --e_decoding False --save_video False --use_substep_decomposition True \
  --num_trials_per_task 50 --evaluation_config_path $FILE_PATH --unnorm_key libero_spatial \
  --task_label scalled_spatial_task_withlang --use_eos_detection True --null_instruction False \
  2>&1 | tee ckpts/scalled_spatial_task_withlang.txt

python experiments/robot/libero/run_libero_pro_eval_substep.py \
  --pretrained_checkpoint $CKPT_APD --substep_completion_threshold 0.07 \
  --task_suite_name libero_10 --e_decoding False --save_video False --use_substep_decomposition True \
  --num_trials_per_task 50 --evaluation_config_path $FILE_PATH --unnorm_key libero_10 \
  --task_label scalled_10_task_withlang --use_eos_detection True --null_instruction False \
  2>&1 | tee ckpts/scalled_10_task_withlang.txt
...
python experiments/robot/libero/run_libero_pro_eval_substep.py \
  ...
  --task_suite_name libero_spatial --e_decoding False --save_video False --use_substep_decomposition True \
  --num_trials_per_task 50 --evaluation_config_path $FILE_PATH --unnorm_key libero_spatial \
  --task_label scalled_spatial_swap_nulllang --use_eos_detection True --null_instruction True \
...
python experiments/robot/libero/run_libero_pro_eval_substep.py \
  ...
  --task_suite_name libero_10 --e_decoding False --save_video False --use_substep_decomposition True \
  --num_trials_per_task 50 --evaluation_config_path $FILE_PATH --unnorm_key libero_10 \
  --task_label scalled_10_swap_nulllang --use_eos_detection True --null_instruction True \
...
python experiments/robot/libero/run_libero_pro_eval_substep.py \
  ...
  --task_suite_name libero_spatial --e_decoding False --save_video False --use_substep_decomposition True \
  --num_trials_per_task 50 --evaluation_config_path $FILE_PATH --unnorm_key libero_spatial \
  --task_label scalled_spatial_object_nulllang --use_eos_detection True --null_instruction True \
...
python experiments/robot/libero/run_libero_pro_eval_substep.py \
  ...
  --task_suite_name libero_10 --e_decoding False --save_video False --use_substep_decomposition True \
  --num_trials_per_task 50 --evaluation_config_path $FILE_PATH --unnorm_key libero_10 \
  --task_label scalled_10_object_nulllang --use_eos_detection True --null_instruction True \
...
python experiments/robot/libero/run_libero_pro_eval_substep.py \
  ...
  --task_suite_name libero_spatial --e_decoding False --save_video False --use_substep_decomposition True \
  --num_trials_per_task 50 --evaluation_config_path $FILE_PATH --unnorm_key libero_spatial \
  --task_label scalled_spatial_lan_nulllang --use_eos_detection True --null_instruction True \
...
python experiments/robot/libero/run_libero_pro_eval_substep.py \
  ...
  --task_suite_name libero_10 --e_decoding False --save_video False --use_substep_decomposition True \
  --num_trials_per_task 50 --evaluation_config_path $FILE_PATH --unnorm_key libero_10 \
  --task_label scalled_10_lan_nulllang --use_eos_detection True --null_instruction True \
...
python experiments/robot/libero/run_libero_pro_eval_substep.py \
  ...
  --task_suite_name libero_spatial --e_decoding False --save_video False --use_substep_decomposition True \
  --num_trials_per_task 50 --evaluation_config_path $FILE_PATH --unnorm_key libero_spatial \
  --task_label scalled_spatial_task_nulllang --use_eos_detection True --null_instruction True \
...
python experiments/robot/libero/run_libero_pro_eval_substep.py \
  ...
  --task_suite_name libero_10 --e_decoding False --save_video False --use_substep_decomposition True \
  --num_trials_per_task 50 --evaluation_config_path $FILE_PATH --unnorm_key libero_10 \
  --task_label scalled_10_task_nulllang --use_eos_detection True --null_instruction True \
